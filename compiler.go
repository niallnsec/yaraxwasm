...
func (c *Compiler) applyLinter(linter compilerLinterSpec) error {
	...
	case compilerLinterTagsAllowed:
		...
		ptr, length, err := c.client.allocAndWrite(payload)
		if err != nil {
			return err
		}
		defer c.client.free(ptr, length, 1)
...
func (c *Compiler) DefineGlobal(ident string, value any) error {
	...
	case map[string]any, []any:
		...
		valuePtr, valueLen, allocErr := c.client.allocAndWrite(jsonBytes)
		if allocErr != nil {
			return allocErr
		}
		defer c.client.free(valuePtr, valueLen, 1)
...
func (c *Compiler) Build() *Rules {
	...
	defer func() {
		_ = c.client.call("go_yrx_rules_destroy", uint64(tmpRulesHandle))
	}()
...
func (c *Compiler) Destroy() {
	...
	if c.client != nil && c.handle != 0 {
		_ = c.client.call("go_yrx_compiler_destroy", uint64(c.handle))
		c.handle = 0
	}
	if c.client != nil {
		c.client.close()
